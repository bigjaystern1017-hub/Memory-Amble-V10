...
export function ChatInput({ onSend, placeholder = "Type your answer...", disabled, autoFocus = true, focusTrigger }: ChatInputProps) {
  ...
  useEffect(() => {
    if (focusTrigger !== undefined && !disabled && inputRef.current) {
      inputRef.current.focus();
    }
  }, [focusTrigger]);
